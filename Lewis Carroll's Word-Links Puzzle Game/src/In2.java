	...
	public final class In2 {
	     ...
	     */
	    public In2(java.net.Socket socket) {
	        try {
	    ...
	    public static int[] readInts(String filename) {
	        return new In2(filename).readAllInts();
	    }
	    ...
	    public static double[] readDoubles(String filename) {
	        return new In2(filename).readAllDoubles();
	    }
	    ...
	    public static String[] readStrings(String filename) {
	        return new In2(filename).readAllStrings();
	    }
	    ...
	    public static void main(String[] args) {
	        ...
	        System.out.println("---------------------------------------------------------------------------");
	        in = new In2("/n/fs/introcs/www/java/stdlib/InTest.txt");
	        try {
	            while (!in.isEmpty()) {
	                String s = in.readLine();
	                System.out.println(s);
	        ...
	        System.out.println("---------------------------------------------------------------------------");
	        try {
	            in = new In2("G:\\www\\introcs\\stdlib\\InTest.txt");
	            while (!in.isEmpty()) {
	                String s = in.readLine();
	                System.out.println(s);
	            }
